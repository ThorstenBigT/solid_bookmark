...
function create_key_value_pair(key: string, value: string) {
  return `${key}='${value}'`
}

function formatAsValidURL(inputString: string): string {
...
browser.runtime.onMessage.addListener((message) => {
    ...
    browser.tabs.create({
      url: final_url, // Replace with the URL you want to open
